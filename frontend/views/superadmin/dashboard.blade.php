        ...
        <aside class="w-64 min-h-screen glass-panel border-r border-white/5 flex flex-col fixed left-0 top-0 z-30">
            ...
            <div class="p-6 border-b border-white/5">
                <div class="flex items-center gap-3">
                    <div>
                        ...
                        <p class="text-[9px] text-slate-500 uppercase tracking-widest mt-1">Superadmin Panel</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-5 border-b border-white/5">
                <div class="flex items-center gap-3 p-3 rounded-2xl bg-slate-800/40 border border-slate-700">
                    <div class="w-10 h-10 rounded-full bg-emerald-600 flex items-center justify-center text-white text-xs font-black border border-slate-700 shadow-xl overflow-hidden">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-[10px] text-emerald-500 uppercase tracking-wide">Owner</p>
                    </div>
                </div>
            ...
            <nav class="flex-1 p-4">
                ...
                <div class="space-y-1">
                    <a href="{{ route('superadmin.dashboard') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400">
                        <i class="fa-solid fa-house text-sm w-5"></i>
                        <span class="text-sm font-semibold">Dashboard</span>
                    </a>
                    <a href="{{ route('superadmin.laporan') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:bg-slate-800/50 hover:text-white transition-all">
                        <i class="fa-solid fa-chart-line text-sm w-5"></i>
                        <span class="text-sm">Laporan</span>
                    </a>
                    <a href="{{ route('superadmin.users') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:bg-slate-800/50 hover:text-white transition-all">
                        <i class="fa-solid fa-user-shield text-sm w-5"></i>
        ...
        <main class="flex-1 ml-64">
            ...
            <header class="bg-[#0f172a]/40 backdrop-blur-xl border-b border-white/5 px-8 py-4 sticky top-0 z-20">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-lg font-black text-white uppercase tracking-tight">Dashboard Superadmin</h2>
                        <p class="text-xs text-slate-500">Full access control panel</p>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="flex items-center bg-emerald-500/10 border border-emerald-500/20 px-3 py-1.5 rounded-full">
                            ...
                            <span class="text-[10px] font-black text-emerald-400 uppercase tracking-wider">Full Access</span>
                        </div>
                    </div>
                </div>
            </header>
                ...
                <div class="glass-panel rounded-[2rem] p-8 mb-8 relative overflow-hidden border border-white/5">
                    ...
                    <div class="relative z-10">
                        <div class="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 px-4 py-1.5 rounded-full mb-4">
                            ...
                            <p class="text-[9px] font-black text-emerald-400 uppercase tracking-[0.3em]">Full Access Granted</p>
                        </div>
                        <h1 class="text-3xl lg:text-4xl font-black text-white mb-2 tracking-tight">
                            Welcome Back, <span class="text-emerald-400">{{ auth()->user()->nama ?? 'Owner' }}!</span>
                        </h1>
            ...
            <footer class="px-8 py-6 border-t border-white/5 bg-[#0f172a]/50">
                <p class="text-xs text-slate-500">&copy; 2026 ALBRK.SHOECARE. All rights reserved. | Superadmin Panel</p>
            </footer>
        </main>
    </div>
</body>
