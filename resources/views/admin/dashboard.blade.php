...
<head>
    ...
    <style>
        * { font-family: 'Inter', sans-serif; }
        ...
        .stat-card {
            background: linear-gradient(135deg, rgba(15, 118, 110, 0.14) 0%, rgba(51, 65, 85, 0.1) 100%);
    ...
    <div class="relative z-10 min-h-screen flex flex-col">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="font-display font-bold text-xl text-white">
                            ALBRK<span class="text-slate-400">.SHOECARE</span>
                        </h1>
            ...
            <div class="relative rounded-2xl p-8 mb-8 overflow-hidden" style="background: linear-gradient(135deg, rgba(15, 118, 110, 0.22) 0%, rgba(51, 65, 85, 0.18) 100%); border: 1px solid rgba(20, 184, 166, 0.2);">
                ...
                <div class="relative z-10">
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <span class="text-xs font-semibold text-slate-400 uppercase tracking-wider">System Active</span>
                    </div>

                    <h1 class="font-display text-3xl lg:text-4xl font-bold text-white mb-3">
                        Selamat Datang, <span class="gradient-text italic">{{ auth()->user()->nama ?? 'Admin' }}!</span>
                    </h1>
                    <p class="text-gray-400 max-w-2xl">
                        Kelola operasional ALBRK.SHOECARE dengan mudah. Pantau antrean, kelola layanan, dan lihat laporan omset.
                    </p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <div class="stat-card rounded-2xl p-5">
                    <div class="flex items-center justify-between mb-3">
                        <div class="w-12 h-12 rounded-xl bg-slate-600/30 flex items-center justify-center">
                            <i class="fa-solid fa-clock text-slate-300 text-lg"></i>
                        </div>
                ...
                <div class="stat-card rounded-2xl p-5">
                    <div class="flex items-center justify-between mb-3">
                        <div class="w-12 h-12 rounded-xl bg-emerald-600/30 flex items-center justify-center">
                ...
                <div class="stat-card rounded-2xl p-5">
                    <div class="flex items-center justify-between mb-3">
                        <div class="w-12 h-12 rounded-xl bg-slate-500/30 flex items-center justify-center">
                ...
                <div class="stat-card rounded-2xl p-5">
                    <div class="flex items-center justify-between mb-3">
                        <div class="w-12 h-12 rounded-xl bg-slate-600/30 flex items-center justify-center">
                            <i class="fa-solid fa-coins text-slate-300 text-lg"></i>
                        </div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                @php
                    $menus = [
                        ...
                        ['url' => route('admin.laporan'), 'icon' => 'fa-chart-line', 'title' => 'Laporan', 'desc' => 'Omset', 'color' => 'text-teal-200', 'bg' => 'bg-slate-700/70'],
                        ['url' => route('admin.users'), 'icon' => 'fa-users', 'title' => 'Pelanggan', 'desc' => 'Database', 'color' => 'text-teal-200', 'bg' => 'bg-slate-700/70'],
                        ['url' => route('admin.layanan.index'), 'icon' => 'fa-box', 'title' => 'Layanan', 'desc' => 'Harga', 'color' => 'text-teal-200', 'bg' => 'bg-teal-500/10'],
                    ];
                @endphp
        ...
        <footer class="border-t border-slate-800 py-6 px-6 text-center">
            <p class="text-gray-600 text-xs">
                &copy; 2026 <span class="text-slate-400 font-semibold">ALBRK.SHOECARE</span> Admin Panel
            </p>
        </footer>
    </div>
