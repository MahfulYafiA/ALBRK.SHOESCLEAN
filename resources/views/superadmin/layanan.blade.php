                ...
                <div class="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
                    ...
                    <form action="{{ route('update.hero.universal') }}" method="POST" enctype="multipart/form-data" class="flex flex-col md:flex-row items-center gap-6 w-full lg:w-auto">
                        ...
                        <div class="relative group/preview w-full md:w-auto">
                            ...
                            <div id="hero_preview_container" class="w-full md:w-64 h-28 md:h-32 bg-slate-800/50 border-2 {{ $hasBanner ? 'border-'.$accent.'-500 border-solid' : 'border-dashed border-slate-700' }} rounded-[1.5rem] md:rounded-[2rem] flex flex-col items-center justify-center overflow-hidden transition-all duration-500 hover:border-slate-500 hover:bg-slate-800 relative shadow-inner">
                                <div id="hero_placeholder" class="flex flex-col items-center gap-2 text-center {{ $hasBanner ? 'hidden' : '' }}">
                    ...
                    <table class="w-full text-left border-collapse min-w-[700px] md:min-w-0">
                        ...
                        <tbody class="divide-y divide-slate-800/50 text-sm">
                            ...
                            <tr class="hover:bg-slate-800/30 transition-all group">
                                <td class="px-8 py-5">
                                    @if($l->gambar)
                                        <img src="{{ route('media.public', ['path' => $l->gambar]) }}" class="w-14 h-14 object-cover rounded-[1rem] shadow-md border border-slate-700">
                                    @else
                                ...
                                <div class="relative w-full max-w-lg bg-slate-900 border border-slate-700 rounded-[2.5rem] shadow-2xl p-8 md:p-10 max-h-[90vh] overflow-y-auto custom-scroll">
                                    ...
                                    <form action="{{ $isSuper ? route('superadmin.layanan.update', $l->id_layanan) : route('admin.layanan.update', $l->id_layanan) }}" method="POST" enctype="multipart/form-data" class="space-y-5 m-0">
                                        ...
                                        <div class="flex justify-center mb-2">
                                            <img id="edit_preview_{{ $l->id_layanan }}" src="{{ $l->gambar ? route('media.public', ['path' => $l->gambar]) : '' }}" class="w-28 h-28 object-cover rounded-[1.5rem] border-4 border-slate-800 shadow-xl {{ $l->gambar ? '' : 'hidden' }}">
                                        </div>
                                        <div>
